...
MY_ACCOUNT_LOCATORS = {
    ...
    'register_user_name': {'type': 'id', 'locator': 'reg_email'},
    'register_user_password': {'type': 'id', 'locator': 'reg_password'},
    'register_user_confirm': {'type': 'css selector', 'locator': '.woocommerce-form-register__submit'},
    'register_user_confirmed':  {'type': 'xpath', 'locator': '//a[contains(text(),"Log out")]'},
