...
class WebCommon(object):
    ...
    def go_to(self, context, location):
    ...
    def assert_page_title(self, context, expected_title):
    ...
    def assert_current_url(self, context, expected_url):
    ...
    def url_contains(self, context, text):
        current_url = context.driver.current_url
    ...
    def assert_url_contains(self, context, text):
        contains = url_contains(text)
        assert contains, f"Current url '{context.driver.current_url}' does not contain text '{text}'."


    def find_element(self, context, locator_attribute, locator_text):
    ...
    def find_elements(self, context, locator_attribute, locator_text):
        possible_locators = ["id", "xpath", "link text", "partial link text", "name", "tag name", "class name", "css selector"]
    ...
    def assert_element_visible(self, context_or_element, locator_att=None, locator_text=None):
    ...
    def type_into_element(self, context_or_element, input_value, locator_att, locator_text):
    ...
    def click(self, context_or_element, locator_att=None, locator_text=None):
    ...
    def element_contains_text(self, context_or_element, expected_text, locator_att, locator_text, case_sensitive=False):
        if isinstance(context_or_element, webdriver.remote.webelement.WebElement):
            element = context_or_element
        else:
            element = context_or_element.driver.find_element(locator_att, locator_text)
    ...
    def assert_element_contains_text(self, context_or_element, expected_text, locator_att, locator_text, case_sensitive=False):
        max_try = 5
        sleep_bn_try = 2
        for i in range(max_try):
            try:
                contains = self.element_contains_text(context_or_element, expected_text, locator_att, locator_text, case_sensitive=False)
    ...
    def assert_radio_is_selected(self, context_or_element, locator_att=None, locator_text=None, case_sensitive=False):
        if isinstance(context_or_element, webdriver.remote.webelement.WebElement):
            element = context_or_element
        else:
            element = context_or_element.driver.find_element(locator_att, locator_text)
    ...
    def get_element_text(self, context_or_element, locator_att=None, locator_text=None):
        if isinstance(context_or_element, webdriver.remote.webelement.WebElement):
